...
jQuery(document).ready(function($){
    ...
    $.each(taxonomy, function(index, tax){
        ...
        $('.compat-attachment-fields').on('modal-refreshed', function(){
            $(input_class).hide();
        ...
        $(metabox_class).on('mouseleave', function() {
        ...
        $('.media-sidebar input').on('click', function(){
